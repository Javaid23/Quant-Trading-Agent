...
def test_risk_score_rises_with_more_risk():
    ...
    low = scorer.score_portfolio(capital_at_risk=0.2, volatility=0.1, drawdown_pct=5)
    high = scorer.score_portfolio(capital_at_risk=0.8, volatility=0.8, drawdown_pct=22)
